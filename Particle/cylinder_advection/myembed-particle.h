...
#line 1 "/home/sagar/basilisk/basilisk/src/../myembed-particle.h"
/**
# Explicit weak fluid-solid coupling

This module is an extension of the
[myembed-moving.h](myembed-moving.h) module. */
...
quantities defined in the module [myembed-moving](myembed-moving.h):
the position *p_p*, velocities *p_u, p_w* and acceleration *p_au,
p_aw* of the discrete rigid body $\Gamma_{\Delta}$.
